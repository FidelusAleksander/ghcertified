/**
 * Games landing page — pick a game mode and certification track.
 *
 * Server component that loads cert catalog, renders game mode cards
 * with cert selection links.
 */
    ...
    <div className="max-w-[1200px] mx-auto px-4 sm:px-8 py-12 sm:py-20">
      ...
      <div className="mb-12">
        <div className="flex items-center gap-2.5 mb-6">
          ...
          <div>
            <h2 className="font-display text-[20px] font-bold text-foreground tracking-tight">
              {t("survivalMode")}
            </h2>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {catalog.map((cert) => {
            ...
            return (
              <Link
                key={cert.cert}
                href={`/${locale}/games/${cert.cert}/survival`}
                    ...
                    <div className="flex items-center gap-3.5">
                      ...
                      <div>
                        ...
                        <div className="text-xs text-muted-foreground mt-0.5">
                          {t("questionsAvailable", { count: cert.questionCount })}
                        </div>
                      </div>
                    </div>
