...
export function GitHubStarButton({ className = "" }: { className?: string }) {
  ...
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className={`inline-flex items-center gap-2 rounded-full bg-[#1a1a2e] px-4 py-2 text-sm font-medium text-white no-underline transition-colors hover:bg-[#24243e] ${className}`}
    >
      {/* GitHub Octocat */}
