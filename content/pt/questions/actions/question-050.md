---
question: "Segredos e variáveis de configuração podem ser definidas para: (Selecione três.)"
title: "Pergunta 050"
---
...
- [ ] Vários repositórios que não compartilham uma organização/enterprise
- [ ] Um fluxo de trabalho específico em um repositório
> As variáveis de ambiente podem ser configuradas para um fluxo de trabalho, variáveis de configuração não podem
- [ ] Um trabalho específico em um
