...
1. [ ] É um serviço de transferência de dados do GitHub para petabytes de dados onde um carro pertencente ao GitHub irá até sua localização e transferirá os dados para sua rede local.
