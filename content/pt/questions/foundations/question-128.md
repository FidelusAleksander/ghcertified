---
title: "Pergunta 128"  
question: "Quais destes você pode personalizar em um arquivo de configuração `.devcontainer/devcontainer.json` no Codespaces? (Escolha três.)"  
draft: false  
---
...
- [x] Configuração de shell  
- [ ] Uso de cobrança do GitHub Actions  
- [x] Nome de exibição do Codespaces  
