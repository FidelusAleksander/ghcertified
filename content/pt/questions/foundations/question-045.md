...
1. [x] Uma visão geral da segurança do repositório, como vulnerabilidades em dependências, resultados de varredura de código e alertas de verificação de segredo
1. [ ] Uma lista de todos os GitHub Issues que foram abertos no repositório por razões de segurança
