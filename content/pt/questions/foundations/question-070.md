...
1. [ ] É um editor de código visual que permite editar seu código-fonte no navegador.
1. [ ] Um repositório no GitHub é uma sala de chat onde os desenvolvedores podem discutir questões relacionadas ao código.
