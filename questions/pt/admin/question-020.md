...
- [ ] Os usuários podem alterar seus nomes de usuários e informações de perfil a qualquer momento no GitHub.
- [ ] Os nomes de usuários e as informações de perfil são definidos pelos próprios usuários durante a configuração da conta no GitHub.
- [ ] O GitHub atribui automaticamente nomes de usuários e informações de perfil aleatórios para maior segurança.
