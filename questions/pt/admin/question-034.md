...
- [ ] Usar serviços de armazenamento em nuvem de terceiros para backup
- [ ] Confiar nos serviços automáticos de backup em nuvem do GitHub
- [ ] Backup manual exportando dados para armazenamento local periodicamente
