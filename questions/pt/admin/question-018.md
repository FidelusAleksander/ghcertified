...
- [ ] As contas de usuário são criadas manualmente por cada usuário no GitHub.com.
- [ ] As contas de usuário são provisionadas pelo GitHub sem qualquer contribuição do IdP da empresa.
- [ ] As contas de usuário são geradas automaticamente com base em endereços de e-mail públicos.
