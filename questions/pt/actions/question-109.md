---
question: "Qual é o propósito da palavra-chave `timeout-minutes` em um step?"
...
- [x] limita o tempo de execução de um step individual
...
- [ ] especifica a duração máxima permitida para a execução de um job
