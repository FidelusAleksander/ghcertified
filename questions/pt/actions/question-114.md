...
```
- [x] referenciando variáveis através do contexto `matrix` com a sintaxe como `matrix.version` e `matrix.os`
- [ ] usando a sintaxe `matrix.property`
- [ ] usando a palavra-chave `context` dentro da configuração do job
