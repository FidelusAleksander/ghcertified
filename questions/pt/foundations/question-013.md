...
- [ ] Adicionando um rótulo com o nome de usuário do GitHub dessa pessoa ao issue ou pull request
- [ ] Mencionando-a na descrição do issue ou pull request
- [ ] Não é possível atribuir uma pessoa a um issue ou pull request.
