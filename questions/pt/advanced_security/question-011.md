...
- [ ] Inclua um arquivo `.gitignore` no seu repositório que ignore arquivos contendo segredos.
- [ ] Crie uma GitHub Action que analise seus commits em busca de segredos antes de serem enviados para o GitHub.
- [ ] Ative uma regra de proteção de branch para seu repositório.
