...
- [ ] Em todos os repositórios da organização, executar a GitHub Action `actions/enable-ghas` com o parâmetro `alerts` definido como `true`.
- [ ] Criar um script que habilitará os Dependabot Alerts em todos os repositórios da organização.
