---
question: "Como parte do seu pipeline Jenkins CI, você criou e analisou com sucesso um banco de dados CodeQL, produzindo assim um arquivo SARIF. Como você pode fazer o upload do arquivo SARIF para o GitHub?"
