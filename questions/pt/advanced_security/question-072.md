---
question: "Quais são as diferenças ao executar a criação do banco de dados CodeQL para linguagens compiladas e interpretadas?"
...
- [ ] Para linguagens interpretadas, a extração funciona monitorando o processo de construção. Todas as informações são coletadas cada vez que o interpretador é invocado para processar um arquivo-fonte.
