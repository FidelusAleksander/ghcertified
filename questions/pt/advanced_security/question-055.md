...
- [ ] A análise de varredura de código está encontrando mais problemas do que o esperado e está levando mais tempo para ser concluída.
- [ ] A varredura de código só pode ser executada em uma programação diária e a organização está sendo cobrada pelo uso adicional.
- [ ] Não há correlação entre a varredura de código e a cobrança do GitHub Actions. A organização está sendo cobrada por outros workflows do GitHub Actions.
