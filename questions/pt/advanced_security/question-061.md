...
- [ ] A varredura de código é acionada a cada push para o repositório.
- [ ] A varredura de código é acionada em uma programação configurável.
- [ ] A varredura de código pode ser acionada em uma programação configurável ou em pull requests.
