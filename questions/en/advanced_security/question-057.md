...
- [ ] You need to install the GitHub Code Scanning tool and configure it for your CI environment.
- [ ] You need to install CodeQL CLI and run it exclusively within the third-party CI pipeline.
- [ ] You need to install GitHub CLI and authenticate it with a personal access token for scanning.
