...
- [ ] It allows the action to upload the results of the analysis to a private GitHub repository that stores historical scan data.
- [ ] It allows the action to access a private GitHub repository that contains the source code to be analyzed by CodeQL.
- [ ] It allows the action to upload the generated CodeQL database to a private GitHub repository for archival purposes.
