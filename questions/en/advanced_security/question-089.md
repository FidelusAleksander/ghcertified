...
- [ ] Use runners with more CPU/RAM resources
- [ ] Parallelize the analysis for multi-language codebases
- [ ] Ignore irrelevant files and directories from the analysis
- [ ] Reduce the number of queries that are run
