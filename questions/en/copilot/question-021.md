...
- [ ] It is limited to generating shell aliases for `gh copilot suggest` and `gh copilot explain`
- [ ] It runs only inside the GitHub web interface and cannot access local project files
- [ ] It automatically executes every suggested shell command without asking for approval
