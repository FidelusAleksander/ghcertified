...
> While you can edit the ["Artifact and log retention" setting](https://docs.github.com/en/organizations/managing-organization-settings/configuring-the-retention-period-for-github-actions-artifacts-and-logs-in-your-organization) in a repository, this applies to all workflows within that repository, not an individual one. This setting does not list out individual workflows.