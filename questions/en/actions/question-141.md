...
> `hashFiles` is not a `actions/cache` input. The `enableCrossOsArchive` input is what enables this Windows-runner functionality according to [official documentation](https://github.com/actions/cache#inputs).
