...
- [ ] プロジェクト内の脆弱性をスキャンするために使用するパッケージマネージャーを指定するための`dependabot.yml`構成ファイル内で定義されるルールです。
- [ ] Dependabotの自動トリアージルールは、プロジェクト内の古い依存関係を自動で削除するために使用されます。
- [ ] 自動トリアージルールは、Dependabotがプロジェクトの脆弱性をどのくらいの頻度でスキャンするかを定義します。
