...
- [ ] リポジトリをローカルマシンに直接クローンして、セルフホストランナーとして自動的に追加する特定のスクリプトを実行します。
- [ ] GitHubサポートにメールで依頼して、リポジトリにセルフホストランナーを追加してもらいます。
- [ ] GitHub APIを使用してセルフホストランナーを手動設定なしで追加するリクエストを送信します。
