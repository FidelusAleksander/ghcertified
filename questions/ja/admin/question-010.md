...
- [ ] SAML SSO を有効化すると、IdP ユーザー全員に対して自動的に新しい GitHub アカウントがプロビジョニングされます。
- [ ] SAML SSO を有効化すると、パブリックリポジトリへのアクセスが不可能になります。
- [ ] SAML SSO を有効化すると、メンバーは IdP ではなく GitHub を通じて認証する必要があります。
