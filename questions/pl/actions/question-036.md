...
1. [ ] Użyj GitHub's REST API, aby sprawdzić, czy liczba zadań jest mniejsza niż 2
1. [ ] To nie jest możliwe, macierz zawsze uruchomi wszystkie zadania równolegle, jeśli są dostępne odpowiednie uruchamiacze
