...
- [ ] Nie istnieje coś takiego jak dependency graph.
- [ ] Jest to narzędzie, które automatycznie proponuje aktualizacje wersji zależności w repozytorium.
- [ ] Jest to lista zarządzana przez GitHub zawierająca znane podatności w pakietach oprogramowania open source.
