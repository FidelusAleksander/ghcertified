...
- [ ] Exigiendo que todos los miembros utilicen autenticación biométrica para acceder a GitHub.
- [ ] Haciendo que todos los repositorios dentro de la organización sean públicos para garantizar la transparencia.
- [ ] Deshabilitando la creación y el procesamiento de issues y pull requests para reducir las superficies de ataque.
