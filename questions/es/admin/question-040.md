...
- [ ] Permite que GitHub funcione como un proveedor de identidad para Microsoft Entra ID, simplificando los procesos de autenticación de usuarios.
- [ ] Convierte automáticamente las membresías de grupo de Microsoft Entra ID en repositorios de GitHub correspondientes, facilitando la asignación de recursos.
- [ ] Respaldar los datos de las organizaciones de GitHub en los servidores de Microsoft Entra ID, proporcionando una capa adicional de redundancia de datos.
