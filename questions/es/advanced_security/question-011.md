...
- [ ] Incluye un archivo `.gitignore` en tu repositorio que ignore archivos que contengan secretos.
- [ ] Crea un GitHub Action que escanee tus commits para buscar secretos antes de que se publiquen en GitHub.
- [ ] Habilita una regla de protección de ramas para tu repositorio.
