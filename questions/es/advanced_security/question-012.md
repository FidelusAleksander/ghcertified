...
- [x] El socio puede tomar acciones tras recibir la notificación de GitHub sobre un secreto filtrado, como revocar el secreto e informar al propietario del secreto comprometido.
- [ ] Otorga al socio acceso a la API de análisis de secretos de GitHub para que el proveedor de servicios pueda analizar los repositorios de GitHub en busca de secretos que coincidan con su formato.
> GitHub siempre es responsable de ejecutar el análisis de secretos, no el socio.
